...
try {
    ...
    // Get orders
    $stmt = $pdo->prepare("
        SELECT o.*, c.crop_name, c.variety, u.full_name as buyer_name, u.phone as buyer_phone, u.email as buyer_email
        FROM orders o
    ...
    $error_message = "Error loading sales data";
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Sales History - Smart Agriculture System</title>
    ...
    <main>
        <div class="container">
            <div class="page-header">
                <h1>Sales History</h1>
                <p>Track all your crop sales and earnings</p>
            </div>
                ...
                <form method="GET" class="filter-form">
                    <div class="filter-row">
                        ...
                        <div class="form-group">
                            ...
                            <a href="sales_history.php" class="btn btn-outline">Clear</a>
                        </div>
                    </div>
                </form>
            </div>
                                ...
                                <?php foreach ($orders as $order): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br><small><?php echo htmlspecialchars($order['buyer_phone']); ?></small>
                                        </td>
    ...
    <script>
        ...
        function viewOrderDetails(orderId) {
            ...
            document.getElementById('orderDetails').innerHTML = `
                ...
                <p>This would show detailed information about the order, buyer contact details, delivery information, etc.</p>
            `;
