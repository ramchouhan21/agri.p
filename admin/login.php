...
if ($_POST) {
    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            $pdo = getDBConnection();
            $stmt = $pdo->prepare("SELECT * FROM users WHERE (username = ? OR email = ?) AND user_type = 'admin'");
...
<head>
    ...
    <title>Admin Login - Smart Agriculture System</title>
            ...
            <div class="login-container">
                ...
                <div class="login-info">
                    ...
                    <ul class="benefits-list">
                        ...
                        <li><i class="fas fa-check"></i> Handle disputes</li>
                        <li><i class="fas fa-check"></i> System analytics</li>
                        <li><i class="fas fa-check"></i> Platform monitoring</li>
